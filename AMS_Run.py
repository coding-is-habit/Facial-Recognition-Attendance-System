    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name=r'C:/Users/Madhav Sharma/Desktop/FAMS/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/Madhav Sharma/Desktop/FAMS/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Users/Madhav Sharma/Desktop/FAMS/Attendance/-------Check atttendance-------"')
...
Btn = Button(window, text = "DEVELOPERS",command=openweb,fg="white" ,bg="reD"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
